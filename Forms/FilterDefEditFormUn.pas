...
type
  TFilterDefEditForm = class(TosCustomEditForm)
    ...
    cdsEditFILTERTYPE: TWideStringField;
    ...
    cdsEditDetailQueryText: TWideMemoField;
    cdsEditDetailAttributeList: TWideMemoField;
    cdsEditDetailExpressionList: TWideMemoField;
    cdsEditDetailConstraintList: TWideMemoField;
    cdsEditDetailOrderList: TWideMemoField;
